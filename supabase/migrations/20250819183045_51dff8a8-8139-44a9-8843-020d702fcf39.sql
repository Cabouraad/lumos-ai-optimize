-- Update the cron jobs to call the correct daily-scheduler function and add better error handling

-- Remove old cron jobs
SELECT cron.unschedule('daily-scan-edt');
SELECT cron.unschedule('daily-scan-est');

-- Create new cron jobs that call daily-scheduler (the correct function)
