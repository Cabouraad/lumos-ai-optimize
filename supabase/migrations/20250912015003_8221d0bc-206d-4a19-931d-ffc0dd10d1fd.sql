-- Update get_unified_dashboard_data to include competitors_json and brands_json fields
...
BEGIN
  ...
  -- CRITICAL FIX: Include competitors_json and brands_json fields
  SELECT COALESCE(
    jsonb_agg(
      jsonb_build_object(
        'id', ppr.id,
        ...
        'competitors_json', ppr.competitors_json,
        'brands_json', ppr.brands_json,
        'run_at', ppr.run_at,
