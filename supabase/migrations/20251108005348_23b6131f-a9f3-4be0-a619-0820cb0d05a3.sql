-- Update get_org_competitor_summary_v2 to handle string/object competitor JSON and filter by brand_catalog
...
COMMENT ON FUNCTION public.get_org_competitor_summary_v2 IS 'Returns competitor summary for an organization, supporting both string/object competitor JSON and filtering to catalog-defined competitors.';