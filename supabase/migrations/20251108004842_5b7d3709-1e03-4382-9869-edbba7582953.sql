...
-- Fix type mismatch in get_org_competitor_summary_v2 return columns
-- Change integer to bigint to match the secure wrapper expectations
...
'Returns competitor summary with bigint counts to match secure wrapper expectations. RLS enforced: users can only query their own org_id.';
