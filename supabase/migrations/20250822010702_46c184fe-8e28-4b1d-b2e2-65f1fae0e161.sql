-- Manually set up the existing admin user
DO $$
DECLARE
...
BEGIN
    ...
    INSERT INTO organizations (
        ...
        'Admin Organization - Amir',
        'admin-amir.llumos.app',
        'pro',
        'pro',
        'Admin organization with full access for Amir'
    ...
    RAISE NOTICE 'Admin user % manually configured with Pro subscription', admin_email;
END $$;