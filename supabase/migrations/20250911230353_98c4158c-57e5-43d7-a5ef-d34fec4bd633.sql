...
begin
  ...
  loop
    execute format('drop policy if exists %I on public.subscribers', r.polname);
  end loop;
end $$;
...
begin
  ...
  loop
    execute format('drop policy if exists %I on public.organizations', r.polname);
  end loop;
end $$;
...
begin
  ...
  loop
    execute format('drop policy if exists %I on public.subscribers_audit', r.polname);
  end loop;
end $$;
