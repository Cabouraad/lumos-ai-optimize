-- Add protective indexes for batch processing performance
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_batch_tasks_job_status 
ON batch_tasks(batch_job_id, status);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_batch_tasks_pending 
