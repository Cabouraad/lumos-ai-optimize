...
-- 1) Fix: rebuild the unified dashboard RPC to use ordered jsonb_agg and consistent jsonb variables
...
-- 2) Performance: keep this aggregate fast on large datasets
