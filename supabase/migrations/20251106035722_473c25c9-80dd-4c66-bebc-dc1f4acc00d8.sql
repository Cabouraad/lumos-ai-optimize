-- Fix get_org_competitor_summary_v2 to check both 'completed' and 'success' status
...
COMMENT ON FUNCTION public.get_org_competitor_summary_v2 IS 
  'Optimized competitor summary with filters (days, providers, brand_id), pagination, and server-side share/trend calculations. Security: enforces org_id check. Supports both completed and success status.';