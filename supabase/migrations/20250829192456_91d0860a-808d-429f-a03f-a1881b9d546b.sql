-- Simple catalog-only cleanup using existing function
SELECT rebuild_competitors_catalog_only();

-- Update hardened get_prompt_competitors function to be even stricter
...
BEGIN
  ...
  aggregated AS (
    ...
    FROM catalog_verified_competitors
