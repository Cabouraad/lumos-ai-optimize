/**
 * Artifact extraction utilities for structured data mining from AI responses (Deno version)
 */

// Duplicate the extractArtifacts functionality for Deno compatibility
